...
class DialogflowTools:
    ...
    def __init__(self, project_id: Optional[str] = None):
        ...
        # BigQuery client for analytics tables
    ...
    async def _run_bq_query(self, sql: str, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # This print will show up in your terminal logs so you can see the real error
            print(f"[DialogflowTools] BQ Execution Error: {str(e)}")
            raise
